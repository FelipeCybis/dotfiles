return {
  ...
  keys = function()
    ...
    return {
      ...
      { "<leader>gcc", function() Snacks.picker.git_log() end,                   desc = "[g]it: [c]ommits (project)" },
      { "<leader>gcb", function() Snacks.picker.git_log_file() end,              desc = "[g]it: [c]ommits ([b]uffer)" },
      ...
      { "<leader>gp",  function() Snacks.picker.gh_pr() end,                     desc = "[g]ithub [p]r (open)" },
      { "<leader>gP",  function() Snacks.picker.gh_pr({ state = "all" }) end,    desc = "[g]ithub [P]r (ALL)" },
      -- find
      { '<leader>fb',  function() Snacks.picker.buffers() end,                   desc = '[f]ind: [b]uffers' },
      { '<leader>ff',  function() Snacks.picker.files() end,                     desc = '[f]ind: [f]iles' },
      { '<leader>fs',  function() Snacks.picker.smart() end,                     desc = '[f]ind: [s]mart files' },
      ...
      { "<leader>sw",  function() Snacks.picker.grep_word() end,                 desc = "[s]earch: grep [w]ord under cursor", mode = { "n", "x", "v" } },
      ...
      -- lsp
      { 'grr',         function() Snacks.picker.lsp_references() end,            desc = 'LSP: [r]eferences (snacks)' },
    }
  end,
  init = function()
